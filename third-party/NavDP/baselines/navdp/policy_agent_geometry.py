...
from policy_network_geometry import NavDP_Policy_Geometry
...
class NavDP_Agent:
    def __init__(self,
        ...
        self.navi_former = NavDP_Policy_Geometry(image_size,memory_size,predict_size,temporal_depth,heads,token_dim,device)
